// =============================================================================
// run_he_inference_qwen3massive.cpp
//
// HE inference for Qwen3-Embedding-0.6B + Linear -> ReLU -> Linear classifier
// trained on MASSIVE-intent (60 classes, 6 locales merged).
//
// Identical algorithmic core to run_he_inference_fgvcaircraft.cpp -- the BSGS
// case_b (input_dim > hidden_dim) chunked-input path naturally handles the
// 1024-dim Qwen3 embeddings under hidden_dim=256 (n_chunks = 1024/256 = 4).
//
// Default artifact_dir: he_artifacts_qwen3_massive_intent_h256
// =============================================================================
...
//            (e.g. FGVC DINOv2: 768/256 = 3 chunks; Qwen3 MASSIVE:
//            1024/256 = 4 chunks). Input is split into
...
int main(int argc, char** argv) {
    // CLI parsing
    string artifact_dir = "he_artifacts_qwen3_massive_intent_h256";
